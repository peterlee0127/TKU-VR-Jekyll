...
// Pano2VR 4.0/3102
// Filename: simplex_map.ggsk
// Generated Mon Mar 18 00:25:29 2013
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._toggle_map.ggId='toggle map';
		...
		this._toggle_map__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;');
		...
		this._toggle_map.onmouseover=function () {
			me._toggle_map__img.src=basePath + 'images/toggle_map__o.svg';
		}
		this._toggle_map.onmouseout=function () {
			me._toggle_map__img.src=basePath + 'images/toggle_map.svg';
		}
		this._controller.appendChild(this._toggle_map);
		...
		this._map_display.innerHTML="<div id=\"mapdiv\" style=\"width:300px; height:200px\">map goes here!<\/div>";
